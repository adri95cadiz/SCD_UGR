...
public class MonitorFumadores extends AbstractMonitor {
    ...
    public void entrafumar(int ingrediente){
			enter();
      if(mesa != ingrediente) {
	    	System.out.println("Fumador "+ ingrediente + " no puede fumar aun, aún necesita la primera dosis de su ingrediente");
	    	puedefumar.get(ingrediente).await();
      }
			mesa = null;
			puedecolocar.signal();
			if(mesa != ingrediente) {
	    	System.out.println("Fumador "+ ingrediente + " no puede fumar aun, aún necesita la segunda dosis de su ingrediente");
	    	puedefumar.get(ingrediente).await();
      }
    ...
    public void colocar(int ingrediente){
			enter();
			static int anteriorIngrediente = null;
			if(anteriorIngrediente = ingrediente)
				System.out.println("Se ha puesto dos veces el mismo ingrediente");
			anteriorIngrediente = ingrediente;
      if(mesa != null)
      	puedecolocar.await();        
      mesa = ingrediente;
